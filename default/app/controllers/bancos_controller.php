...
class BancosController extends AppController
{
    ...
    {
        View::template(null);
         $this->listRegistros = (new Bancos())->getRegistros($page);
    }
    ...
    public function crear()
    {
        ...
        if (Input::hasPost('registros')) {
            ...
            $registro = new Bancos(Input::post('registros'));
    ...
    public function editar($id){
        ...
        $buscado = (new Bancos())->find_by_id((int)$id);
        ...
        if($buscado != NULL){
            ...
            if(Input::hasPost('registros')){
                if($registro->update(Input::post('registros'))){
                    ...
                    return Redirect::to('bancos/listar');
                }
    ...
    public function ver($id){
        View::template(null);
        $this->buscado = (new Bancos())->find_by_id((int)$id);
    }
}
