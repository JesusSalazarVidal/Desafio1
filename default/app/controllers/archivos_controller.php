...
class ArchivosController extends AppController
{
    ...
    {
        View::template(null);
         $this->listRegistros = (new Archivos())->getRegistros($page);
    }
    ...
    public function crear()
    {
        ...
        if (Input::hasPost('registros')) {
            ...
            $registro = new Archivos(Input::post('registros'));
    ...
    public function editar($id){
        ...
        $buscado = (new Archivos())->find_by_id((int)$id);
        ...
        if($buscado != NULL){
            ...
            if(Input::hasPost('registros')){
                if($registro->update(Input::post('registros'))){
                    ...
                    return Redirect::to('archivos/listar');
                }
    ...
    public function ver($id){
        View::template(null);
        $this->buscado = (new Archivos())->find_by_id((int)$id);
    }
}
