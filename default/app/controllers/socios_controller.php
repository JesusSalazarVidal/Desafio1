...
class SociosController extends AppController
{
    ...
    {
        View::template(null);
         $this->listRegistros = (new Socios())->getRegistros($page);
    }
    ...
    public function crear()
    {
        ...
        if (Input::hasPost('registros')) {
            ...
            $registro = new Socios(Input::post('registros'));
    ...
    public function editar($id){
        ...
        $buscado = (new Socios())->find_by_id((int)$id);
        ...
        if($buscado != NULL){
            ...
            if(Input::hasPost('registros')){
                if($registro->update(Input::post('registros'))){
                    ...
                    return Redirect::to('socios/listar');
                }
    ...
    public function ver($id){
        View::template(null);
        $this->buscado = (new Socios())->find_by_id((int)$id);
    }
}
