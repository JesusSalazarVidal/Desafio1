...
class DescuentosController extends AppController
{
    ...
    {
        View::template(null);
         $this->listRegistros = (new Descuentos())->getRegistros($page);
    }
    ...
    public function crear()
    {
        ...
        if (Input::hasPost('registros')) {
            ...
            $registro = new Descuentos(Input::post('registros'));
    ...
    public function editar($id){
        ...
        $buscado = (new Descuentos())->find_by_id((int)$id);

        if($buscado != NULL){
            $registro = new Descuentos();
            //verificar si se ha enviado el formulario
            if(Input::hasPost('registros')){
                if($registro->update(Input::post('registros'))){
                    Flash::valid('Operacion exitosa');
                    return Redirect::to('descuentos/listar');
                }
    ...
    public function ver($id){
        View::template(null);
        $this->buscado = (new Descuentos())->find_by_id((int)$id);
    }
}
