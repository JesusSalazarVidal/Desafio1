...
class UsuariosController extends AppController
{
    ...
    {
        View::template(null);
         $this->listRegistros = (new Usuarios())->getRegistros($page);
    }
    ...
    public function crear()
    {
        ...
        if (Input::hasPost('registros')) {
            ...
            $registro = new Usuarios(Input::post('registros'));
    ...
    public function editar($id){
        ...
        $buscado = (new Usuarios())->find_by_id((int)$id);
    ...
    public function ver($id){
        View::template(null);
        $this->buscado = (new Usuarios())->find_by_id((int)$id);
    }
}
